...
mongoose.connect("mongodb+srv://shamimansari2354:Shamim4@cluster0.trfob2i.mongodb.net/Healthmenteedb", { useNewUrlParser: true }).then(console.log("connected to database!"));
